...
const CountryCode = ({setCountryCode}) => {
  ...
  const handleCountryChange = (e) =>{
        ...
        codeBox.current.innerText = "+" + box.current.options[e.target.selectedIndex].value
  ...
  return (
      <Selectbox>
          ...
          <select ref={box} name = "country-code" id="country_list" onChange={handleCountryChange} >
